...
class CVP_Replace_Setting {
	...
	function get_archives() {
		...
		$this->archives_list = array(
			...
			0				 => array( __( 'Standard Archives', 'content-views-pro' ), array(
					'home'	 => __( 'Posts page (<em><a target="_blank" href="https://docs.contentviewspro.com/completely-replace-wordpress-layout-by-content-views-pro-layout/#which">Blog page</a></em>)' ),
	...
	function show_form() {
		...
		<style>
			...
			.cvp-rep-intro, .cvp-rep-intro *{font-size:16px}
		</style>
		<script>
			( function ( $ ) {
		...
		<div class="wrap">
			...
			<div class="pt-wrap cvp-admin">
				<form action="" method="POST">
					...
					$sort_options	 = array( '' => __( 'Use order & results of page &rarr; Click To Change', 'content-views-pro' ), 'use_view_order' => __( 'Use "Sort by" setting of View', 'content-views-pro' ), 'use_filter_settings' => __( 'Use "Filter Settings" of View (replace result)', 'content-views-pro' ) );
	...
	function show_notice() {
		...
		$msg[]	 = __( 'You should create new View for replacing purpose.', 'content-views-pro' );

		printf( '<div class="cvp-rep-intro"><p>%s</p></div>', implode( '</p><p>', $msg ) );
	}
