                    ...
                    if ( $cff_show_post ) {
                        ...
                        if($cff_offset_show_post){
                            ...
                            if( !$cff_photos_only && !$cff_videos_only && !($cff_albums_only && $cff_albums_source == 'photospage') && empty($cff_album_id) && !$cff_reviews ){
                                ...
                                if( isset($news->call_to_action->type->value->link) ){
                                    $post_text .= '<a href="https://facebook.com'.$news->call_to_action->value->link.'" target="_blank" class="cff-cta-link" data-app-link="'.$news->call_to_action->value->app_link.'">'.ucwords(strtolower( str_replace('_',' ',$news->call_to_action->type) ) ).'</a>';
                                }
